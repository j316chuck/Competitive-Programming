...
int n, q;
//dp tree = solve leaf cases, find recurrence relation that needs permutation to solve, use dp.
//constraints n is large q is very small or n and q are both medium size. O(nq^2) usually.
